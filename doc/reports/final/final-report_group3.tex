...
\begin{itemize}
  ...
  \item deserialize
  \item serialize
  \item protocol - size of file - actual file
  \item Nagel's algorithm
  \item Do not wait for answer of ECU
\end{itemize}
\subsection{Data exchange with ECU}
\begin{itemize}
  \item MQTT/mosquitto/publish subscribe
  \item callbacks
  \item lwip mosquitto foo
\end{itemize}
\section{ECU}
\section{Misc}
\begin{itemize}
