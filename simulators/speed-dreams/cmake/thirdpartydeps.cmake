...
IF(OPTION_SIMCOUPLER OR OPTION_PARKING)
  # Boost
  ...
  MACRO(ADD_PROTOBUF_LITE_LIBRARY TARGET)

    IF(HAVE_PROTOBUF)
      TARGET_LINK_LIBRARIES(${TARGET} ${PROTOBUF_LITE_LIBRARIES})
    ELSE(HAVE_PROTOBUF)
      MESSAGE(FATAL_ERROR "Cannot find Protobuf libraries")
    ENDIF(HAVE_PROTOBUF)

  ENDMACRO(ADD_PROTOBUF_LITE_LIBRARY TARGET)
ENDIF(OPTION_SIMCOUPLER OR OPTION_PARKING)
