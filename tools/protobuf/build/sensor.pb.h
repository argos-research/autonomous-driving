...
class Sensor : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protobuf.Sensor) */ {
 public:
  Sensor();
  virtual ~Sensor();
  ...
  ::protobuf::Sensor_SensorType type() const;
  void set_type(::protobuf::Sensor_SensorType value);
...
inline ::protobuf::Sensor_SensorType Sensor::type() const {
  // @@protoc_insertion_point(field_get:protobuf.Sensor.type)
  return static_cast< ::protobuf::Sensor_SensorType >(type_);
}
inline void Sensor::set_type(::protobuf::Sensor_SensorType value) {
...
template <> struct is_proto_enum< ::protobuf::Sensor_SensorType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::protobuf::Sensor_SensorType>() {
  return ::protobuf::Sensor_SensorType_descriptor();
}
